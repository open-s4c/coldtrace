...
// per-thread writer
void coldtrace_init_x(struct metadata *md, uint64_t thread_id);
void coldtrace_fini_x(struct metadata *md);
void *coldtrace_append_x(struct metadata *md, entry_type type, const void *ptr);
